...
<?php  
	...
	$username = htmlspecialchars(strtolower(stripcslashes($data ["username"])));//stripcslashes berfungsi untuk membersihkan karakter backslash sedangkan strtolowwer berfungsi supaya yang dimasukkan user itu huruf kecil, misal jika user registrasi username dengan huruf besar,tapi sewaktu login user juga bisa dengan huruf kecil.
